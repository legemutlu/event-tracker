...
<PageHeader header="Welcome Back" secondaryHeader="Nice to see you again"/>

<section class="container pt-8 pb-8 lg:pt-18 lg:pb-18">
    <div class="flex place-content-center">
        <div class="p-4 w-1/3 min-w-max bg-white rounded-lg border border-gray-200 shadow-md sm:p-6 lg:p-8 dark:bg-gray-800 dark:border-gray-700">
            <form class="space-y-6" action="#">
                <h5 class="text-xl font-medium text-center text-gray-900 dark:text-white">SIGN IN</h5>
                <div>
